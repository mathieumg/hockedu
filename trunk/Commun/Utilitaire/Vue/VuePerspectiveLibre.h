...
/// @{
//////////////////////////////////////////////////////////////////////////////
#ifndef __UTILITAIRE_VuePerspectiveLibre_H__
#define __UTILITAIRE_VuePerspectiveLibre_H__
...
namespace vue {
   ...
   ////////////////////////////////////////////////////////////////////////
   /// @class VuePerspectiveLibre
   /// @brief Classe concrète de vue perspective.
   ///
   /// Cette classe implante le comportement attendu d'une vue perspective libre.
   ///
   /// @author Mathieu Parent
   /// @date 2012-03-16
   ////////////////////////////////////////////////////////////////////////
   class VuePerspectiveLibre : public Vue
   {
   public:
      // Constructeur.
      VuePerspectiveLibre(const Camera& camera,
...
#endif // __UTILITAIRE_VuePerspectiveLibre_H__
