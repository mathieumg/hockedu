...
/// @{
//////////////////////////////////////////////////////////////////////////////
#ifndef __UTILITAIRE_VuePerspectiveOrbit_H__
#define __UTILITAIRE_VuePerspectiveOrbit_H__
...
namespace vue {
   ...
   ////////////////////////////////////////////////////////////////////////
   /// @class VuePerspectiveOrbit
   /// @brief Classe concrète de vue perspective.
   ///
   /// Cette classe implante le comportement attendu d'une vue perspective orbtit autour de la rondelle.
   ///
   /// @author Mathieu Parent
   /// @date 2012-03-16
   ////////////////////////////////////////////////////////////////////////
   class VuePerspectiveOrbit : public Vue
   {
   public:
      // Constructeur.
      VuePerspectiveOrbit(const Camera& camera,
...
#endif // __UTILITAIRE_VuePerspectiveOrbit_H__
