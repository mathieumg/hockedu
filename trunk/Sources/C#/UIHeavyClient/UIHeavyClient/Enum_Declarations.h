...
typedef enum
#endif
    {
		...
		ACTION_ALLER_MODE_EDITION_PAS_DEFAUT_XML,
...
typedef enum
#endif
    {
        ...
        GAME_SERVER_USER_CONNECTED,
        GAME_SERVER_USER_DISCONNECTED,
        ...
        GAME_CONNECTION_RESPONSE_GAME_CONNECTION_GENERAL_FAILURE,
        GAME_CONNECTION_RESPONSE_WRONG_PASSWORD_CS,
        GAME_CONNECTION_RESPONSE_MATCHMAKING,
        EXIT_NETWORK_GAME,
        SERVER_EVENT_END,
