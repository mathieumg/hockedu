...
public:
    ...
    int addNewGame(GameType gametype, SPJoueurAbstrait pJoueur1 = 0, SPJoueurAbstrait pJoueur2 = 0, bool pForceParameters = false, bool pIsLearningGame=false, int pGameId = -1);
