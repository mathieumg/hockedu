...
///////////////////////////////////////////////////////////////////////////
/// @class NodeTableControlPoint
/// @brief Classe qui représente les points déplacable de l'aire de jeu.
///
/// @author Samuel Ledoux, Michael Ferris
/// @date 2012-01-25
///////////////////////////////////////////////////////////////////////////
class NodeTableControlPoint : public NoeudComposite, public PositionSubject
{
public:
	...
	NodeTableControlPoint( float coordX, float coordY, TypePosPoint typePosNoeud);
	/// Destructeur.
	virtual ~NodeTableControlPoint();
	...
	NodeTableControlPoint* obtenirPointSym() const;
	/// Mutateur de pointHorizontalSym_
	void modifierPointSym(NodeTableControlPoint* pointSym);
    ...
    void setTypePosNoeud( TypePosPoint val )
    {
        typePosNoeud_ = val;
    }
private:
...
private:
	...
	NodeTableControlPoint* pointSym_;
