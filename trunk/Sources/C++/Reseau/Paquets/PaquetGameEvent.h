...
enum GameEventCode {GAME_EVENT_READY, GAME_EVENT_START_GAME, GAME_EVENT_PAUSE_GAME_REQUESTED, GAME_EVENT_PAUSE_GAME_USER_DISCONNECTED, GAME_EVENT_PLAYER_SCORED, GAME_EVENT_GAME_ENDED, GAME_EVENT_ERROR};
