...
enum effect
{
	...
	ACCELERATOR_EFFECT,
    BONUS_FAN_IN_EFFECT,
    BONUS_BLOCK_GOAL_IN_EFFECT,
    BONUS_BLOCK_GOAL_OUT_EFFECT,
    BONUS_CHANGE_SIDE_IN_EFFECT,
    BONUS_CHANGE_SIDE_OUT_EFFECT,
    BONUS_PASS_WALL_IN_EFFECT,
    BONUS_PASS_WALL_OUT_EFFECT,
};
